...
class appProdDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'D:/wamp/www/GestionDesTournois/app/cache/prod/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('D:/wamp/www/GestionDesTournois/app/cache/prod/assetic/config'), true)));
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager54dd4a0780794_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager54dd4a0780794_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once 'D:/wamp/www/GestionDesTournois/app/cache/prod/jms_diextra/doctrine/EntityManager_54dd4a0780794.php';

        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_fc421b794ba84dec332050ed2e3f7a17');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_fc421b794ba84dec332050ed2e3f7a17');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_fc421b794ba84dec332050ed2e3f7a17');
        ...
        $f->setProxyDir('D:/wamp/www/GestionDesTournois/app/cache/prod/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager54dd4a0780794_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($g, $this);
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('D:/wamp/www/GestionDesTournois/app/cache/prod/jms_diextra/metadata'));
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('D:/wamp/www/GestionDesTournois/app/logs/prod.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:D:/wamp/www/GestionDesTournois/app/cache/prod/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'D:/wamp/www/GestionDesTournois/app/config/routing.yml', array('cache_dir' => 'D:/wamp/www/GestionDesTournois/app/cache/prod', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appprodUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appprodUrlMatcher', 'strict_requirements' => NULL), $this->get('router.request_context'), $this->get('monolog.logger.router'));
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('D:/wamp/www/GestionDesTournois/app/cache/prod/jms_security/expressions');
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('D:/wamp/www/GestionDesTournois/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security'));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('D:/wamp/www/GestionDesTournois/app/cache/prod/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('D:/wamp/www/GestionDesTournois/app/cache/prod/sessions');
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'cache' => 'D:/wamp/www/GestionDesTournois/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
     ...
     *
     * @return EntityManager54dd4a0780794_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'D:/wamp/www/GestionDesTournois/app/../web', true);
    }
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('D:/wamp/www/GestionDesTournois/app/cache/prod/jms_security', true));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'D:/wamp/www/GestionDesTournois/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'D:/wamp/www/GestionDesTournois/app/cache/prod',
            ...
            'debug.container.dump' => 'D:/wamp/www/GestionDesTournois/app/cache/prod/appProdDebugProjectContainer.xml',
            ...
            'session.save_path' => 'D:/wamp/www/GestionDesTournois/app/cache/prod/sessions',
            ...
            'profiler.storage.dsn' => 'file:D:/wamp/www/GestionDesTournois/app/cache/prod/profiler',
            ...
            'router.resource' => 'D:/wamp/www/GestionDesTournois/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'D:/wamp/www/GestionDesTournois/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.memory.path' => 'D:/wamp/www/GestionDesTournois/app/cache/prod/swiftmailer/spool',
            ...
            'assetic.cache_dir' => 'D:/wamp/www/GestionDesTournois/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'D:/wamp/www/GestionDesTournois/app/cache/prod/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => 'D:/wamp/www/GestionDesTournois/app/cache/prod/jms_aop',
            ...
            'jms_di_extra.cache_dir' => 'D:/wamp/www/GestionDesTournois/app/cache/prod/jms_diextra',
            'jms_di_extra.disable_grep' => false,
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.cache_warmer.controller_file_blacklist' => array(

            ),
            'jms_di_extra.doctrine_integration.entity_manager.file' => 'D:/wamp/www/GestionDesTournois/app/cache/prod/jms_diextra/doctrine/EntityManager_54dd4a0780794.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager54dd4a0780794_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => 'D:/wamp/www/GestionDesTournois/app/cache/prod/jms_security',
